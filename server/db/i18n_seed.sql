...
-- Generated by i18n sweep. Run via: mariadb <db> < server/db/i18n_seed.sql
...
('btn.invite',                    'en', 'Invite'),
('btn.invite',                    'et', 'Kutsu'),
('btn.send_invite',               'en', 'Send invite'),
('btn.send_invite',               'et', 'Saada kutse'),
('label.invite_friend_title',     'en', 'Invite a friend'),
('label.invite_friend_title',     'et', 'Kutsu sõber'),
('msg.invite_explain',            'en', "Your friend will receive an email with a link to join. You'll get +10 lumens right away, and +10 more if they sign up."),
('msg.invite_explain',            'et', 'Sinu sõber saab e-kirja liitumislingiga. Sa saad kohe +10 lumenit ja veel +10, kui ta liitub.'),
('placeholder.friend_email',      'en', "Friend's email"),
('placeholder.friend_email',      'et', 'Sõbra e-post'),
('msg.invite_sent',               'en', 'Invite sent!'),
('msg.invite_sent',               'et', 'Kutse saadetud!'),
('msg.invite_failed',             'en', 'Could not send the invite. Please try again.'),
('msg.invite_failed',             'et', 'Kutse saatmine ebaõnnestus. Palun proovi uuesti.'),
('msg.invalid_email',             'en', 'Enter a valid email address.'),
('msg.invalid_email',             'et', 'Sisesta kehtiv e-posti aadress.'),
('msg.already_a_member',          'en', 'This person already has a Map of Knowledge account.'),
('msg.already_a_member',          'et', 'Sellel inimesel on juba Map of Knowledge konto.'),
...
('hh.more_info',                  'en', 'More info'),
('hh.more_info',                  'et', 'Lisainfo'),
('hh.reflections_text',           'en', 'Writing reflections helps you connect ideas, spot gaps and improve how you learn; in one controlled study, students using reflective journals scored about 26% higher and retained the advantage over time (<a href="https://doi.org/10.59175/pijed.v4i2.799" target="_blank" rel="noopener">Nurhidayah et al., 2025</a>).'),
('hh.reflections_text',           'et', 'Mõtisklused aitavad sul ideid siduda, märgata lünki ja õppida paremini; ühes kontrollitud uuringus said mõtiskluspäevikut pidanud õpilased ligikaudu 26% kõrgemaid tulemusi ja säilitasid selle eelise ka hiljem (<a href="https://doi.org/10.59175/pijed.v4i2.799" target="_blank" rel="noopener">Nurhidayah et al., 2025</a>).'),
('hh.practice_text',              'en', 'Recalling information strengthens the memory and reveals what you do not yet know; in <a href="https://journals.sagepub.com/doi/10.1111/j.1467-9280.2006.01693.x" target="_blank" rel="noopener">Roediger and Karpicke (2006)</a>, learners who practised recall remembered 61% a week later, compared with 40% after repeated studying.'),
('hh.practice_text',              'et', 'Teabe meeldetuletamine tugevdab mälu ja paljastab, mida sa veel ei tea; <a href="https://journals.sagepub.com/doi/10.1111/j.1467-9280.2006.01693.x" target="_blank" rel="noopener">Roediger ja Karpicke (2006)</a> uuringus mäletasid aktiivset meeldetuletamist harjutanud õppijad nädal hiljem 61%, korduvalt lugenud õppijad aga vaid 40%.'),
...
('help.node_l5',                'en', 'L5 (individual concept): "Learn this" opens the knobit, "Test me" starts a diagnostic test, and "I know this" is also available here.'),
('help.lesson_title',           'en', 'The knobit'),
('help.lesson_body',            'en', 'Each knobit has four parts: explanation, example, practice, and meaning (why it matters). At any point you can say "too simple" or "too complex," ask for a different explanation, or ask questions directly inside the knobit via the ask bar.'),
('help.lootbox_title',          'en', 'Loot Box'),
('help.lootbox_body',           'en', 'While working on a knobit, a button next to the topic name opens the Loot Box — bonus resources for that exact topic: a video, a game, a real place tied to the topic, a podcast episode, a book, a recent news story, a fun fact, a timeline, someone to follow, and a hands-on project. Not every topic has all ten — only the ones that genuinely fit are shown.'),
...
('help.iquest_title',           'en', 'IQuest — streaks, lumens, and rank'),
('help.iquest_body',            'en', 'Your Learner Passport also tracks your momentum: a daily streak for studying at least a little every day, lumens (points) for completing lessons, tests, and reflections, a rank that climbs as you earn lumens, achievement medals for milestones, and a leaderboard of top learners. Open IQuest on your Learner Passport to see it all — each card\'s "i" icon explains exactly how it works.'),
...
('account.login_method_passkey',  'en', 'Passkey'),
('account.login_method_passkey',  'et', 'Pääsuvõti'),
...
('account.passkeys',              'en', 'Passkeys'),
('account.passkeys',              'et', 'Pääsuvõtmed'),
('account.passkeys_desc',         'en', 'Sign in with your fingerprint, face, or a security key — no password needed.'),
('account.passkeys_desc',         'et', 'Logi sisse sõrmejälje, näo või turvavõtmega — parooli pole vaja.'),
('account.add_passkey',           'en', 'Add a passkey'),
('account.add_passkey',           'et', 'Lisa pääsuvõti'),
('account.no_passkeys',           'en', 'No passkeys added yet.'),
('account.no_passkeys',           'et', 'Pääsuvõtmeid pole veel lisatud.'),
('account.passkey_unnamed',       'en', 'Unnamed device'),
('account.passkey_unnamed',       'et', 'Nimetu seade'),
('account.added_on',              'en', 'Added'),
('account.added_on',              'et', 'Lisatud'),
('account.passkeys_unsupported',  'en', 'Your browser doesn\'t support passkeys.'),
...
('account.disconnect_confirm_title',  'en', 'Disconnect this sign-in method?'),
('account.disconnect_confirm_title',  'et', 'Ühendada see sisselogimisviis lahti?'),
('account.disconnect_confirm_suffix', 'en', 'will no longer be a way to sign in to your account.'),
('account.disconnect_confirm_suffix', 'et', 'ei ole enam üks sinu sisselogimisviisidest.'),
...
('btn.ke_manual_trigger',        'en', 'Read My Mind'),
('btn.ke_manual_trigger',        'et', 'Loe mu mõtteid'),
...
('msg.ke_loading_title',         'en', 'Reading your mind...'),
('msg.ke_loading_title',         'et', 'Loeme sinu mõtteid...'),
