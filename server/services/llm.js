...
- Lumens & Rank: lumeneid teenib knobiti lõpetamisega (+10), terve teema lõpetamisega (+25 juurde), terve suurema üksuse lõpetamisega (+100 juurde), teadmiste testi sooritamisega olenemata tulemusest (+10), refleksiooni kirjutamisega (+5) ja Õppijapassi profiili täitmisega ühekordselt (+10) — kõike korrutab hoo (momentum) kordaja. See algab tasemelt ×1.00 ja kasvab, mida järjepidevamalt õppija lumeneid teenib (ligikaudu kord päevas, ükskõik millise knobiti/testi/refleksiooni vms eest): ×1.25, kui see on juhtunud 2-3 järjestikusel päeval, ×1.50 4-6 päeva korral, ×2.00 7 või enama päeva korral. Kui rohkem kui 72 tundi ei toimu ühtki lumeneid teenivat tegevust, langeb kordaja tagasi tasemele ×1.00. See EI ole seotud eelmise seeriaga — eraldi mehaanika, mida jälgitakse iseseisvalt. Praegune kordaja ja taseme nimi (Alustamas/Hoogu kogumas/Ühtlane retk/Täispurjes) on näha väikese sildina sellel kaardil ja otsingukasti kõrval ülal, kui boonus on aktiivne. Tase (rank) tõuseb redelil kogutud lumenite põhjal.
...
- Lumens & Rank: lumens are earned by completing a knobit (+10), finishing an entire topic (+25 more), finishing everything under a bigger unit (+100 more), completing a knowledge test regardless of score (+10), writing a reflection (+5), and completing their Learner Passport profile once (+10) — all scaled up by a momentum multiplier. It starts at ×1.00 and climbs the more consistently they earn lumens (roughly once per day, on any day they do a knobit/test/reflection/etc.): ×1.25 once that's happened on 2-3 separate days in a row, ×1.50 at 4-6 days, ×2.00 at 7+ days. If more than 72 hours pass with no lumens-earning activity at all, it drops straight back to ×1.00. This is unrelated to the streak above — a separate mechanic, tracked independently. The current multiplier and tier name (Setting out/Building pace/Steady expedition/Full sail) show as a small badge on this card and next to the topbar streak icon whenever a bonus is active. Rank climbs a ladder based on total lumens.
